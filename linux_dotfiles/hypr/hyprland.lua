...
hl.on("hyprland.start", function() 
    hl.exec_cmd("awww-daemon -f argb")
    hl.exec_cmd("waybar")

    -- Use the [workspace x;silent] exec flag format
    ...
    hl.exec_cmd("[workspace 5 silent] protonvpn-app")
    hl.exec_cmd("[workspace 5 silent] blueman-manager")
end)
...
hl.animation({ leaf = "workspaces",    enabled = true,  speed = 1,      bezier = "quick", style = "fade" })
...
hl.bind(mainMod .. " + N", hl.dsp.exec_cmd("blueman-manager"))
